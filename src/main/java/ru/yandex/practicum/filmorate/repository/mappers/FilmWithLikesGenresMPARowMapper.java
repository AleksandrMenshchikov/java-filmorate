...
@Component
public class FilmWithLikesGenresMPARowMapper implements RowMapper<FilmWithLikesGenresMPA> {
    @Override
    public FilmWithLikesGenresMPA mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        return FilmWithLikesGenresMPA.builder()
                .id(rs.getLong("id"))
